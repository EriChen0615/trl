...
class DPORKDTrainer(Trainer):
    r"""
    Initialize DPORKDTrainer.
    ...
    @_deprecate_arguments(
        ...
        custom_message="Deprecated positional argument(s) used in DPORKDTrainer, please use the DPOConfig to set these arguments instead.",
    )
    ...
    def __init__(
        ...
        if model_init_kwargs is not None:
            warnings.warn(
                "You passed `model_init_kwargs` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if args.model_init_kwargs is None:
            ...
            raise ValueError(
                "You passed model_init_kwargs to the DPORKDTrainer/DPOConfig, but your model is already instantiated."
            )
        else:
        ...
        if ref_model_init_kwargs is not None:
            warnings.warn(
                "You passed `ref_model_init_kwargs` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if args.ref_model_init_kwargs is None:
            ...
            raise ValueError(
                "You passed ref_model_init_kwargs to the DPORKDTrainer/DPOConfig, but your ref_model is already instantiated."
            )
        else:
        ...
        if isinstance(model, str):
            warnings.warn(
                "You passed a model_id to the DPORKDTrainer. This will automatically create an "
        ...
        if isinstance(ref_model, str):
            warnings.warn(
                "You passed a ref model_id to the DPORKDTrainer. This will automatically create an "
                "`AutoModelForCausalLM`"
            )
        ...
        if force_use_ref_model:
            warnings.warn(
                "You passed `force_use_ref_model` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if not is_peft_available() and peft_config is not None:
            ...
            if ref_model is not None and not args.force_use_ref_model:
                raise ValueError(
                    ...
                    " model. Please pass `ref_model=None` in case you want to train PEFT adapters, or pass a ref_model with `force_use_ref_model=True` in DPORKDTrainer's init."
        ...
        if generate_during_eval:
            warnings.warn(
                "You passed `generate_during_eval` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if is_encoder_decoder is not None:
            warnings.warn(
                "You passed `is_encoder_decoder` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if model is not None:
            ...
            raise ValueError(
                "When no model is provided, you need to pass the parameter is_encoder_decoder to the DPORKDTrainer/DPOConfig."
            )
        else:
        ...
        if model_adapter_name is not None:
            warnings.warn(
                "You passed `model_adapter_name` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if ref_adapter_name is not None:
            warnings.warn(
                "You passed `ref_adapter_name` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if reference_free:
            warnings.warn(
                "You passed `reference_free` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if precompute_ref_log_probs:
            warnings.warn(
                "You passed `precompute_ref_log_probs` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if max_length is not None:
            warnings.warn(
                "You passed `max_length` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
            args.max_length = max_length

        if max_prompt_length is not None:
            warnings.warn(
                "You passed `max_prompt_length` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
            args.max_prompt_length = max_prompt_length

        if max_target_length is not None:
            warnings.warn(
                "You passed `max_target_length` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
            args.max_completion_length = max_target_length

        if label_pad_token_id != -100:
            warnings.warn(
                "You passed `label_pad_token_id` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
            args.label_pad_token_id = label_pad_token_id

        if padding_value is not None:
            warnings.warn(
                "You passed `padding_value` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if not disable_dropout:
            warnings.warn(
                "You passed `disable_dropout` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if truncation_mode != "keep_end":
            warnings.warn(
                "You passed `truncation_mode` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
        ...
        if loss_type is not None:
            warnings.warn(
                "You passed `loss_type` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
            args.loss_type = loss_type
        if label_smoothing != 0:
            warnings.warn(
                "You passed `label_smoothing` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
            args.label_smoothing = label_smoothing
        if (
            args.loss_type in ["hinge", "ipo", "bco_pair", "sppo_hard", "nca_pair", "apo_zero", "apo_down", "rao-kupper", "davidson"]
        ...
        if args.loss_type == "kto_pair":
            raise ValueError("Support for kto_pair has been removed in DPORKDTrainer. Please use KTOTrainer.")
        ...
        if dataset_num_proc is not None:
            warnings.warn(
                "You passed `dataset_num_proc` to the DPORKDTrainer, the value you passed will override the one in the `DPOConfig`."
            )
    ...
    def tokenize_row(features, processing_class, max_prompt_length, max_completion_length, add_special_tokens):
        ...
        Args:
            features (`Dict[str, str]`):
                Row of the dataset, should contain the keys `"prompt"`, `"chosen"`, `"rejected"`, and `"is_tie"`.
        ...
        >>> DPORKDTrainer.tokenize_row(features, tokenizer, max_prompt_length=3, max_completion_length=3, add_special_tokens=False)
        ...
        return {
            ...
            "is_tie": features['is_tie'], #NOTE JC: must have
        }
    ...
    def dpo_loss(
        ...
        Args:
            ...
            is_ties (`torch.BoolTensor`):
                Indicates whether a pair is a tie (1) or a clear preferene (0). Shape: `(batch_size,)`
    ...
    def create_model_card(
        ...
        citation = textwrap.dedent(
            """\
            @inproceedings{CHen2023DPO-RKD,
                title        = {{On Extending Direct Preference Optimization to Accommodate Ties}},
                author       = {Jinghong Chen, Guangyu Yang, Weizhe Lin, Jingbiao Mei, Bill Byrne},
                year         = 2024,
                url          = {https://arxiv.org/abs/2409.17431},
            }"""
        )
        ...
        model_card = generate_model_card(
            ...
            trainer_name="DPO-RKD",
            trainer_citation=citation,
            paper_title="On Extending Direct Preference Optimization to Accommodate Ties",
            paper_id="2409.17431",
        )
